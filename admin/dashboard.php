...
include 'inc/auth/functions.php';
   ...
   <div class="row">
    <div class="col-lg-3 col-6">
     ...
     <div class="small-box bg-info">
      <div class="inner">
       <h3><?php echo countCategories(0); ?></h3>

       <p>Total Parent Categories</p>
      </div>
      <div class="icon">
